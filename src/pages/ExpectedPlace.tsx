...
const infoHotel = {
  ...
  img: [
    'https://lh3.googleusercontent.com/p/AF1QipMbsuZz6kbPn72mv7yy3ke_FYQLLerGGMG6cNYw=s1360-w1360-h1020',

    'https://lh3.googleusercontent.com/proxy/RzvZmax6FkJW02jRnra0v_DkFPHjvaEpq2yTm4pBsxJYGzFSiD-eebSHHdECO1iMjb5xhqPNvjTmFgvA4Jsm3Joad-sZA9I2SJBY_Oinhk8KAOVPWOMaf_IkaMhciMTGOiZDDAPMlKEir9VaWRxdkLt_g2Ys1JA=s1360-w1360-h1020',

    'https://lh3.googleusercontent.com/p/AF1QipPCirEx8vGCnVxPkuF9wuz12RLI4LeoIa2HMi1C=s1360-w1360-h1020',

    'https://lh3.googleusercontent.com/p/AF1QipOCDtixR66cLv2kEp4gIdFlh8xs5wAoA2t7VTzg=s1360-w1360-h1020',

    'https://lh3.googleusercontent.com/p/AF1QipOAgC47KMUSvkUfLD8g2D4JInDES9pH0SDulT9y=s1360-w1360-h1020',
  ],
};
...
const usuariosReview = [
  ...
  },
  {
    ...
    descripcion:
      'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Esse corrupti laborum possimus ad eligendi iusto, perferendis atque accusantium consequatur facere.',
    img: ['/assets/san-nicolas-buenos-aires.webp'],
  },
];
    ...
    <>
      ...
      <section className="w-full mb-5">
        <div className="sm:w-10/12 m-auto">
          <ImageGallery images={infoHotel.img} height={70}></ImageGallery>

          <div className="px-2 sm:px-0 flex flex-col gap-y-4">
            <h1 className="text-center">{infoHotel.place}</h1>
