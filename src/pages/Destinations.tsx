      ...
      <section>
        <div className="bg-[#E6E6E6] w-full h-[120px]">
          <div className="container mx-auto h-full flex flex-col items-center justify-center gap-y-4">
            <p className="max-w-[450px] text-center font-semibold tracking-tight">
            ...
            <div>
              <form action="" className="flex items-center relative">
                <input
                  className="w-[450px] rounded outline-none p-1"
                  type="text"
        ...
        <div className="flex ">
          <svg width="600" height="500" viewBox="305 275 463 696">
            <g>
              <path
          ...
          <div className="flex flex-col gap-y-6 border-l-[1px]   border-gray-50 p-4">
            <div>
              <h1 className="font-semibold text-[56px] xl:text-[80px] leadind-[1.1]">
                Buenos Aires
              </h1>
            ...
            <div className="bg-gray-50/50 rounded-lg">
              ...
              <button className="btn-blue mb-4">Ver más publicaciones</button>
            </div>
          </div>
        </div>
      </section>
