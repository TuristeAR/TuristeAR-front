...
function ItinerayCard(props: {
  ...
  return (
    <>
      <div className="w-[100%] p-8 rounded-2xl shadow-[0_10px_25px_-10px_rgba(0,0,0,4)] ">
        ...
        <div>
          <div className="text-gray-500 dark:text-gray-400 lg:flex mt-3 lg:justify-around grid grid-cols-2">
