              ...
              <div className="divContentCreateEvent bg-white rounded-2xl md:py-6 py-4 lg:px-10 px-6 flex flex-col justify-evenly relative md:max-w-[70%] max-w-[90%] min-w-[60%] max-h-[90%]">
                ...
                <form onSubmit={createEvent} className={'grid grid-cols-2 items-center gap-4'}>
                  ...
                  <div>
                    ...
                    <input className={'max-w-[100%]'} type="file" />
                  </div>

                  <div className="">
                    <label id="fromDate" className={'font-semibold'}>
                      Fecha de inicio
                    </label>
                    <input
                  ...
                  <div className="flex flex-col">
                    <label id="toDate" className={'font-semibold'}>
                      Fecha de fin
                    </label>
                    <input
                  ...
                  <div className={'flex flex-col'}>
                    <label id="locality" className={'font-semibold'}>
                      Localidad
                    </label>
                    <select
                      className={'border border-[#999999] rounded-xl px-2'}
                  ...
                  <div className="flex flex-col">
                    <label id="description" className={'font-semibold'}>
                      Descripción
                    </label>
                    <textarea
                      className={'border border-[#999999] rounded-xl px-2'}
