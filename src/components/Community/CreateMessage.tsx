...
export const CreateMessage = (props: { user: User, forum: Forum | null, setForum: (forum: (prevForum) => (null | any)) => void }) => {
  const {user, forum, setForum} = props;
