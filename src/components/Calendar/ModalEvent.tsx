              ...
              <div className="flex flex-col  md:flex-row">
                <div className="flex flex-1 flex-col items-start gap-y-2">
                  ...
                  <Link
                    ...
                    className="flex items-center gap-x-2 text-md md:text-lg font-semibold whitespace-normal break-words text-gray/95 hover:text-gray/70 md:my-3 md:ml-7 cursor-pointer"
                  >
